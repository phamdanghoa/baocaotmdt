								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/<?php echo $row_sanpham['sanpham_image'] ?>" alt="hinh anh">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
												<a href="<?php echo $row_sanpham['sanpham_id'] ?>/<?php echo convert_name($row_sanpham['sanpham_name'] )?>" class="link-product-add-cart">Xem sản phẩm</a>
												</div>
											</div>
										</div>
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="<?php echo $row_sanpham['sanpham_id'] ?>/<?php echo convert_name($row_sanpham['sanpham_name'] )?>"><?php echo $row_sanpham['sanpham_name'] ?></a>
											</h4>
								...
								<div class="scroll">
									...
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="images/<?php echo $row_sanpham_sidebar['sanpham_image'] ?>" alt="hinh anh" class="img-fluid">
										</div>
