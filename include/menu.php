				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<li class="nav-item  mr-lg-2 mb-lg-0 mb-2">
							...
							<a class="nav-link " href="danh-muc/<?php echo $row_category_danhmuc['category_id'] ?>/<?php echo convert_name($row_category_danhmuc['category_name']) ?>" role="button"  aria-haspopup="true" aria-expanded="false">
						...
						<li class="nav-item">
							<a class="nav-link" href="https://www.facebook.com/cuahangonlinemocua24h">Liên hệ FanPage</a>
						</li>
					</ul>
				</div>
			</nav>
